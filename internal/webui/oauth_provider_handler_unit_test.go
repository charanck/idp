...
func newOAuthProviderHandlerFixture() (*fakeOAuthProviderStore, *fakeActivityRecorder, *webui.OAuthProviderHandler) {
	providers := newFakeOAuthProviderStore()
	activity := &fakeActivityRecorder{}
	h := webui.NewOAuthProviderHandler(providers, activity)
