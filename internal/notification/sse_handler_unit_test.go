...
func TestStream_MissingBearerTokenReturns401(t *testing.T) {
	...
	h := notification.NewSSEHandler(&fakeSessionValidator{}, &fakeSubscriber{rdb: rdb})
...
func TestStream_InvalidTokenReturns401(t *testing.T) {
	...
	h := notification.NewSSEHandler(&fakeSessionValidator{err: errFakeNotificationService}, &fakeSubscriber{rdb: rdb})
