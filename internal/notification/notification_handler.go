...
// NotificationCreator is the narrow slice of *NotificationService that
...
// NotificationLister is the narrow slice of *NotificationService that
// NotificationHandler.List needs.
type NotificationLister interface {
	ListNotifications(ctx context.Context, filter ListNotificationsFilter) ([]Notification, error)
}

// NotificationGetter is the narrow slice of *NotificationService that
...
func NewNotificationHandler(creator NotificationCreator, lister NotificationLister, getter NotificationGetter, channels ChannelRegistry) *NotificationHandler {
...
func (h *NotificationHandler) Create(c echo.Context) error {
	...
	n, err := h.creator.CreateNotification(c.Request().Context(), CreateNotificationInput{
		Channel:        req.Channel,
...
var (
	_ NotificationCreator = (*NotificationService)(nil)
	_ NotificationLister  = (*NotificationService)(nil)
	_ NotificationGetter  = (*NotificationService)(nil)
)
