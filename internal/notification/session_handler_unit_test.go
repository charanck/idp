...
func TestSessionCreate_MissingUserIDReturns400(t *testing.T) {
	h := notification.NewSessionHandler(&fakeSessionIssuer{})
...
func TestSessionCreate_IssuerErrorReturns500(t *testing.T) {
	h := notification.NewSessionHandler(&fakeSessionIssuer{err: errFakeNotificationService})
...
func TestSessionCreate_ReturnsTokenAsJSON(t *testing.T) {
	h := notification.NewSessionHandler(&fakeSessionIssuer{token: "minted-token"})
