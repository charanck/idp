...
func main() {
	...
	webHandlers := &web.Handlers{
		...
		Auth:                 web.NewAuthHandler(svc.Auth, svc.OAuth, svc.RateLimiter, svc.Activity, cfg.AuthRateLimit, cfg.AuthRateLimitWindowSeconds, cfg.CookieDomain),
		Profile:              web.NewProfileHandler(svc.Auth),
		OAuthLogin:           web.NewOAuthLoginHandler(svc.OAuth, svc.Activity, cfg.CookieDomain),
