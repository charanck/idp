...
class ConfigEntryForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.instance and self.instance.pk and self.instance.is_secret and not self.is_bound:
            self.initial["value"] = ""
            self.fields["value"].widget.attrs["placeholder"] = "Enter full replacement secret value"
